...
Shader "DickShader"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_150_0_g1 = ( float3(0,0,1) * distanceToHole180_g1 );
			...
			float3 lerpResult152_g1 = lerp( temp_output_149_0_g1 , ( normalizeResult156_g1 * min( length( temp_output_149_0_g1 ) , 0.1 ) ) , saturate( ( temp_output_149_0_g1.z * 10.0 ) ));
...
Node;AmplifyShaderEditor.FunctionNode;36;-769.4998,515.1;Inherit;False;PenetratorDeformation;0;;1;ac383a8a454dc764caec4e7e5816beae;0;3;64;FLOAT3;0,0,0;False;69;FLOAT3;0,0,0;False;71;FLOAT4;0,0,0,0;False;4;FLOAT3;61;FLOAT3;62;FLOAT4;63;FLOAT;0
...
WireConnection;0;11;36;61
WireConnection;0;12;36;62
ASEEND*/
//CHKSM=4DA103F1B45472902361035B2A2714FE3EA46785