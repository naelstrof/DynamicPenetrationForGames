...
Shader "Vilar/EyeNaelEdit"
{
	Properties
	{
		...
		_SceleraEmission("SceleraEmission", Float) = 0
		_StylizedReflection("StylizedReflection", 2D) = "black" {}
	...
	SubShader
	{
		...
		uniform sampler2D _StylizedReflection;
		...
		uniform float _SceleraEmission;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 normalizeResult7_g9 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
			float3 normalizeResult27_g10 = normalize( normalizeResult7_g9 );
			float3 viewToWorldDir6_g9 = normalize( mul( UNITY_MATRIX_I_V, float4( float3(0,1,0), 0 ) ).xyz );
			float3 normalizeResult31_g10 = normalize( viewToWorldDir6_g9 );
			float3 normalizeResult29_g10 = normalize( cross( normalizeResult27_g10 , normalizeResult31_g10 ) );
			float mulTime398 = _Time.y * 0.8;
			float temp_output_410_0 = round( mulTime398 );
			float2 temp_cast_1 = (temp_output_410_0).xx;
			float simplePerlin2D389 = snoise( temp_cast_1 );
			float2 temp_cast_2 = (( temp_output_410_0 + 123.234 )).xx;
			float simplePerlin2D403 = snoise( temp_cast_2 );
			...
			float2 temp_cast_3 = (temp_output_418_0).xx;
			float simplePerlin2D425 = snoise( temp_cast_3 );
			float2 temp_cast_4 = (( temp_output_418_0 + 123.234 )).xx;
			float simplePerlin2D426 = snoise( temp_cast_4 );
			...
			float2 temp_cast_5 = (mulTime445).xx;
			float simplePerlin2D447 = snoise( temp_cast_5 );
			...
			float3 lerpResult646 = lerp( UnpackNormal( tex2D( _BumpMap, ( float3( temp_output_650_29 ,  0.0 ) + temp_output_411_0 ).xy ) ) , float3(0,0,1) , temp_output_650_30);
			float3 newWorldNormal8_g9 = (WorldNormalVector( i , lerpResult646 ));
			float dotResult10_g9 = dot( normalizeResult29_g10 , newWorldNormal8_g9 );
			float dotResult11_g9 = dot( cross( normalizeResult29_g10 , normalizeResult27_g10 ) , newWorldNormal8_g9 );
			float2 appendResult12_g9 = (float2(dotResult10_g9 , dotResult11_g9));
			...
			float4 lerpResult638 = lerp( float4( 0,0,0,0 ) , lerpResult636 , temp_output_650_30);
			...
			float2 temp_cast_9 = (mulTime578).xx;
			float simplePerlin2D580 = snoise( temp_cast_9 );
			...
			float4 tex2DNode2 = tex2D( _MainTex, localParallaxOcclusionDialated600 );
			float4 color641 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
			float4 lerpResult702 = lerp( tex2DNode2 , color641 , temp_output_650_30);
			o.Albedo = saturate( ( tex2Dlod( _StylizedReflection, float4( ( ( appendResult12_g9 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ), 0, 0.0) ) + lerpResult639 + lerpResult702 ) ).rgb;
			float4 lerpResult640 = lerp( ( tex2DNode2 * _EmissionPower ) , color641 , temp_output_650_30);
			o.Emission = ( ( lerpResult639 * _SceleraEmission ) + lerpResult640 ).rgb;
...
Node;AmplifyShaderEditor.RangedFloatNode;457;-5178.437,-1027.651;Float;False;Property;_TwitchShiftyness;TwitchShiftyness;14;0;Create;True;0;0;0;False;0;False;0;0.057;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;468;-2493.207,-1004.077;Float;False;Property;_PupilDialationFrequency;PupilDialationFrequency;12;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;412;-3426.62,-1628.825;Float;False;Property;_TwitchMagnitude;TwitchMagnitude;13;0;Create;True;0;0;0;False;0;False;0.1;0.059;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;610;-2613.717,-2348.637;Float;False;Property;_IrisSize;IrisSize;11;0;Create;True;0;0;0;False;0;False;0;0.551;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;616;-2611.575,-2437.144;Float;False;Property;_IrisBlend;IrisBlend;10;0;Create;True;0;0;0;False;0;False;0;0.1;0;0.3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;650;-1861.564,-2486.867;Inherit;False;GenerateIris;-1;;8;2646035ac41a7da46bc344e10053cf4d;0;3;31;FLOAT2;0,0;False;25;FLOAT;0;False;24;FLOAT;0;False;4;FLOAT;30;FLOAT2;29;FLOAT;27;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;633;981.9465,-2754.731;Inherit;False;Property;_Scelera;Scelera;4;0;Create;True;0;0;0;False;0;False;0.6470588,0.6185122,0.6185122,0;0.6470588,0.6185122,0.6185122,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-520.7863,-1090.895;Float;False;Property;_Depth;Depth;9;0;Create;True;0;0;0;False;0;False;0.5236971;0.6;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;634;1007.668,-2574.487;Inherit;False;Property;_Blood;Blood;6;0;Create;True;0;0;0;False;0;False;0.4705882,0.3737024,0.3737024,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;635;1025.234,-2989.386;Inherit;False;Property;_IrisRing;IrisRing;7;0;Create;True;0;0;0;False;0;False;1,0,0,1;0.3043362,0.2171146,0.3867925,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;33;1140.05,-1237.327;Float;False;Property;_EmissionPower;EmissionPower;3;0;Create;True;0;0;0;False;0;False;0;0.5;0;10000;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;2;1117.968,-1633.946;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;700;251.8237,-2469.106;Inherit;True;Property;_StylizedReflection;StylizedReflection;16;0;Create;True;0;0;0;False;0;False;None;None;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;685;1329.442,-2372.138;Inherit;False;Property;_SceleraEmission;SceleraEmission;15;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;699;670.675,-2377.086;Inherit;False;Matcap;-1;;9;93800e3390a5f0b448caf60440e9b780;0;2;21;SAMPLER2D;0;False;19;FLOAT3;0,0,1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;686;2205.469,-1871.309;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;288;1875.034,-1773.312;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;687;2168.155,-1452.176;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;30;1985.318,-1138.401;Float;False;Property;_Smooth;Smooth;8;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;701;2126.298,-1716.447;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;708;2590.219,-1452.336;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Vilar/EyeNaelEdit;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;699;21;700;0
WireConnection;699;19;646;0
WireConnection;702;0;2;0
WireConnection;702;1;641;0
WireConnection;702;2;650;30
WireConnection;686;0;639;0
WireConnection;686;1;685;0
WireConnection;288;0;699;0
WireConnection;288;1;639;0
WireConnection;288;2;702;0
...
WireConnection;687;1;640;0
WireConnection;574;0;602;0
WireConnection;574;1;572;0
WireConnection;574;2;573;0
WireConnection;701;0;288;0
WireConnection;708;0;701;0
WireConnection;708;2;687;0
WireConnection;708;4;30;0
ASEEND*/
//CHKSM=50262F40504DE90C16B27AAE9E48C6D7A5B7BF18